...
1. The new information is added to the vault (e.g. creating/updating files under `references/` or `examples/`).
...
3. If the final answer is an exceptionally useful or reusable E3D macro or UI gadget form, **the agent files it back into the vault** as a permanent template.
