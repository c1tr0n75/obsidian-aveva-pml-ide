...
* **Artifact Clusters**: `examples/pml-patterns/`, `examples/kpi-reports/`, and `project-knowledge/` form separate graph regions for reusable PML, generated dashboards, and durable engineering context. KPI report packages use Markdown wrappers, manifests, static summaries, and CSV exports so interactive HTML dashboards remain visible, linkable, auditable, and regenerable inside Obsidian.
